    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Idioma = c.String(maxLength: 15),
                        Moneda = c.String(maxLength: 15),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Destinos", t => t.IdDestino, cascadeDelete: true)
                .Index(t => t.IdDestino);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Resenas", "IdDestino", "dbo.Destinos");
            ...
            DropIndex("dbo.Resenas", new[] { "IdDestino" });
